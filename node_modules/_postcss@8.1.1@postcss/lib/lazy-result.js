...
class LazyResult {
  constructor (processor, css, opts) {
    ...
    console.log('lazy-result root',root.nodes[0].nodes)
    this.result = new Result(processor, root, opts)
    console.log('lazy-result result ',this.result)
    ...
    console.log('lazy-result plugins',this.plugins)
  }
  ...
  stringify () {
    ...
    console.log('lazy-result',this.result)
    return this.result
  }
